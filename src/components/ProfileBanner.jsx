...
<div className="custom-shape-divider-top-1712947828">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        <path d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z" className="shape-fill"></path>
                    ...
                    <div className="col-md-8 align-content-center">
                        <div className="hidden2 profile_square">
                            ...
                            <div className="container">
                                    <p>Soy un Ingeniero con experiencia en gestión de proyectos, con habilidades analíticas y de resolución de problemas.</p>  
                                    <p>He trabajado en proyectos personales utilizando tecnologías de desarrollo front-end como lo son HTML, CSS, JavaScript y el framework de React para la creación de sitios web dinámicos.</p>
                                    <p>Me gusta ser parte de un equipo de trabajo y afrontar nuevos desafíos, me apasiona el aprendizaje y la formación constante para ampliar mi conocimiento y seguir creciendo en mi carrera.</p>                       
            ...
            <div className="custom-shape-divider-bottom-1712948696">
